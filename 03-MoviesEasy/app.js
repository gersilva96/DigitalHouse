...
const server = http.createServer((req, res) => {
    ...
    switch (req.url) {
        case '/':
            ...
            res.end(`${tituloHome}\n\n\nTotal de películas en cartelera: ${totalPelis}\n\n\n${pelisOrdenadasString}\n\n\n${pieDePagina}`);
            break;
        ...
        case '/sucursales':
            ...
            let totalSalas = theaters.length;
            let listadoSalas = "";
        ...
        case '/preguntas-frecuentes':
            ...
            res.end(`${tituloFaq}\n\n\nTotal de Preguntas y Respuestas: ${totalFaq}\n\n\n${listadoFaq}`);
            break;
...
server.listen(port, host, console.log(`Servidor corriendo en el puerto ${port}`));